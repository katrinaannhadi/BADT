...
public class Blog {
    ...
    //String representing the topic name to be used for the title of the BlogActivity
    ...
    //Integer that stores the drawable to be used in the imageview of BlogActivity
    ...
    public Blog(String topic, int topicNo, String subTopic, String information, int subTopicImage) {
        this.topic = topic;
    ...
    //Method returning an arrayList containing the variables for each topic to be set into the views of the BlogActivity
    //Method returning an arrayList for Design Thinking
    public static ArrayList<Blog> getDesignThinking() {

        //Create a new arraylist to contain the variables
        ArrayList<Blog> designThinkingList = new ArrayList<>();

        //Insert new topics into the arraylist which can be used in BlogActivity
        designThinkingList.add(new Blog(
        ...
        designThinkingList.add(new Blog("Design Thinking",2,"Design Thinking Mindsets","•\tHuman-Centred: Involving the client in every step of the process\n" +
        ...
        designThinkingList.add(new Blog("Design Thinking",3,"Design Thinking Steps","Following Stanford Design Schools’ Design Thinking Process, there are 5 stages: Empathise, Define, Ideate, Prototype and Test. " +
        ...
        designThinkingList.add(new Blog("Design Thinking",6,"Ideate","The ideate stage is all about generating ideas to the problem that has just been identified and selected.\n" +
        ...
        designThinkingList.add(new Blog("Design Thinking",7,"Prototype","The prototype stage is all about bringing the ideas to life by creating something tangible that the users can interact with. This helps further empathise with customers, understand what the solution may do well or poorly and to also gain additional insights that weren’t considered before. \n" +
    ...
    public static ArrayList<Blog> getAgileSCRUM() {
        ArrayList<Blog> agileList = new ArrayList<>();
        agileList.add(new Blog("Agile SCRUM", 1,"Introduction","An agile methodology is the opposite end of the spectrum to waterfall development which focuses on sequential, well-planned project management. Agile instead focuses on a series of fast iterations or ‘sprints’ that focus on producing results rapidly and often results in products being produced at the end of each sprint.\n" +
        ...
        agileList.add(new Blog("Agile SCRUM", 2,"Roles","Product owner\n" +
        ...
        agileList.add(new Blog("Agile SCRUM", 3,"Ceremonies","Sprint planning\n" +
        ...
        agileList.add(new Blog("Agile SCRUM", 4,"Artifacts","Product vision\n" +
    ...
    public static ArrayList<Blog> getLeanStartup() {
        ...
        leanStartupList.add(new Blog("Lean Startup", 2,"Identify and prioritise your assumptions","To identify assumptions, start by making “I believe that” statements. \n" +
    ...
    public static ArrayList<Blog> getSDLC() {
        ArrayList<Blog> sdlcList = new ArrayList<>();
        sdlcList.add(new Blog("Systems Development Lifecycle", 1,"Introduction","The Systems Development Lifecycle (SDLC) is a simple depiction of a typical lifecycle of every information system (IS). It consists of four phases: Planning, Analysis, Design and Implementation; and can be executed sequentially, incrementally, iteratively or in any pattern that is deemed appropriate by team working on the IS. Each phase also consists of a series of steps and is documented through deliverables.",R.drawable.sdlc));
        sdlcList.add(new Blog("Systems Development Lifecycle", 2,"Planning","The planning phase is focused on defining the reason for building the system and how to structure the project. Some common steps performed during this phase includes:\n" +
        ...
        sdlcList.add(new Blog("Systems Development Lifecycle", 3,"Analysis","The analysis phase is focused on who the system is being built for, what the system is, where it will be used and when it will be built. Some common steps performed during this phase includes:\n" +
                "\t•Developing an analysis strategy \n" +
                "\t•Determine business requirements\n" +
                "\t•Create use cases\n" +
                "\t•Model processes\n" +
                "\t•Model data\n",R.drawable.analysis));
        sdlcList.add(new Blog("Systems Development Lifecycle", 4,"Design","The design phase focuses on the actual design of the system such as how the system will work. Some common steps in this phase include designing the physical system, architecture, interface, programs and database and files.",R.drawable.design));
        sdlcList.add(new Blog("Systems Development Lifecycle", 5,"Implementation","Implementation focuses on the delivery and support of the completed system. In this stage some common steps include:\n" +
    ...
    public static ArrayList<Blog> getSystemsDevelopmentMethodologies() {
        ArrayList<Blog> systemDevMethodList = new ArrayList<>();
        systemDevMethodList.add(new Blog("Systems Development Methodology", 1,"Waterfall",
        ...
        systemDevMethodList.add(new Blog("Systems Development Methodology", 2,"Parallel",
        ...
        systemDevMethodList.add(new Blog("Systems Development Methodology", 3,"Phased",
        ...
        systemDevMethodList.add(new Blog("Systems Development Methodology", 4,"System Prototyping",
        ...
        systemDevMethodList.add(new Blog("Systems Development Methodology", 5,"Throwaway Prototyping",
    ...
    public static ArrayList<Blog> getIntroductiontoBA() {
        ArrayList<Blog> introToBaList = new ArrayList<>();
        introToBaList.add(new Blog("Introduction to Business Analysis", 1,"Introduction", "An information system is a system that collects, stores, processes and retrieves information and turns raw data into business insight.\n" +
        ...
        introToBaList.add(new Blog("Introduction to Business Analysis", 3,"BA roles across different types of organisations", "There are three main different types of organisations: Conservative, progressive and avant-garde. \n" +
    ...
    public static ArrayList<Blog> getProjectManagement() {
        ArrayList<Blog> projectManagementList = new ArrayList<>();
        projectManagementList.add(new Blog("Project Management", 1,"Introduction", "A project is a set of activities with a beginning and an ending point, meant to create a system, which when completed, is expected to deliver value to the business\n" +
        ...
        projectManagementList.add(new Blog("Project Management", 2,"System Request", "The system request is a document that describes the reasons for and the value added from building a new system. It typically contains five elements:\n" +
        ...
        projectManagementList.add(new Blog("Project Management", 3,"Feasibility Analysis", "Feasibility analysis considers the potential risks and potential benefits of the project to make a decision about whether it is viable to conduct it. There are three major components of feasibility analysis:\n" +
        ...
        projectManagementList.add(new Blog("Project Management", 4,"Stakeholder Analysis", "Stakeholder analysis allows the business to understand the key stakeholders, their interests in the system and what kind of influence they have. \n" +
        ...
        projectManagementList.add(new Blog("Project Management", 5,"Project Management Process", "Project selection refers to the choice of approving, declining or delaying a project based on the value added against risks of the project. Selected projects then enter the project management process.\n" +
        ...
        projectManagementList.add(new Blog("Project Management", 6,"Requirement Analysis Strategies", "Requirements Analysis Strategies are a part of requirements determination and are decided upon during the preparation phase. There are three main requirements analysis strategies.\n" +
    ...
    public static ArrayList<Blog> getReqGatheringAndModelling() {
        ArrayList<Blog> reqGatheringAndModellingList = new ArrayList<>();
        reqGatheringAndModellingList.add(new Blog("Requirements Gathering And Modelling", 1, "Requirements Gathering Techniques", "The requirements gathering process is used to uncover requirements and is a collaborative activity to build support and trust among users. Some commonly used techniques include interviews, joint application development, surveys, document analysis and observations.\n" +
        ...
        reqGatheringAndModellingList.add(new Blog("Requirements Gathering And Modelling", 2,"Requirement Modelling Techniques","Requirements Modelling helps visualise the requirements of the system to allow communication and collaboration between the developers and users. \n" +
        ...
        reqGatheringAndModellingList.add(new Blog("Requirements Gathering And Modelling", 3,"Use Case Diagram","A use-case diagram is a functional model that identifies use-cases (what the user can do) and how the system responds. Each use-case describes on function or business process of the system.\n" +
        ...
        reqGatheringAndModellingList.add(new Blog("Requirements Gathering And Modelling", 4,"Activity Diagram","An activity diagram is a functional model that models a business process (use-case) and the flow of its activities. Each use case diagram will have at least one activity diagram for every major use case. Activity diagrams depict the sequence of these activities.\n" +
        ...
        reqGatheringAndModellingList.add(new Blog("Requirements Gathering And Modelling", 5,"Class Diagram","A class diagram is a structural model that shows classes and the relationships to one another. Within class diagrams, there are various elements: Classes, attributes, operations and relationships.\n" +
        ...
        reqGatheringAndModellingList.add(new Blog("Requirements Gathering And Modelling", 6,"Sequence Diagram","A sequence diagram is a behavioural model that models the dynamic and real-life timings of a use-case. It illustrates the object that participate in a single use case and how they interact with each other (through messages). To understand the diagram, the vertical plane (from top to bottom) depicts time. \n" +
