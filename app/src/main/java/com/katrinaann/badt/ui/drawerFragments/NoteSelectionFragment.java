...
public class NoteSelectionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTopics.add(new Model(R.drawable.ic_leanstartup, "Lean Startup", "We got your back. Sit back and watch informational videos on finance curated by the team!", 8));
